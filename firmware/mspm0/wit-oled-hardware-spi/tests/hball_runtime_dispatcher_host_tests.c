...
static void test_single_release_runs_can_once_in_foreground(void)
{
...
static void test_disabled_can_consumes_release_without_business_work(void)
{
    hball_runtime_dispatcher_t dispatcher;
    fake_runtime_t runtime;
    hball_runtime_dispatcher_hooks_t hooks;
...
int main(void)
{
    test_single_release_runs_can_once_in_foreground();
    test_backlog_is_coalesced_without_unbounded_catch_up();
    test_disabled_can_consumes_release_without_business_work();
