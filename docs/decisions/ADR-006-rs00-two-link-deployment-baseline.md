...
Date: 2026-07-30; amended 2026-07-31 for measured linkage
...
- 水管物理长度250 mm；视觉零点到两侧物理挡边各112 mm、到C轴155 mm，向C为负；
- 水管摇杆CB 300.1 mm、主动杆OA 35.0 mm、连接杆AB 55.5 mm；
- RS00轴高38 mm、右侧合页C轴高93 mm、O-C水平距离285 mm，支撑台不低于50 mm；
- 当前相机基线为100 Hz；
- JY901S UART已为115200 bit/s，加速度、角速度与姿态报告实测各约199.6 Hz；
...
4. C是右侧固定合页，水平时`C->B`向左。当前正常水管角优先`+-4 deg`、恢复
   `+-5.5 deg`、软件硬指令限位`+-6 deg`、斜率`0.35 rad/s`。`+-6 deg`内
   最小`|dtheta/dq|=0.0467`，加工变化必须重算机构。
5. 当前三类IMU量均以200 Hz唯一源序号处理；CAN重复镜像不刷新新鲜度，
   三类不完整时M33不置`IMU_VALID`。
