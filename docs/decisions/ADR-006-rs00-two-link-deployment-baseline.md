...
- 水管有效滚动长度250 mm，水管摇杆CB 300.1 mm、主动杆OA 35.0 mm、连接杆AB 55.5 mm；
- RS00轴高38 mm、右侧合页C轴高93 mm、O-C水平距离285 mm，支撑台不低于50 mm；
- 当前相机基线为100 Hz；
- WIT UART已设为115200 bit/s，模型采用200 Hz唯一样本；500 Hz完整组仍超过链路容量；
...
5. 当前控制和仿真按200 Hz唯一IMU源样本和8 ms延迟处理；200 Hz CAN镜像中的重复值不刷新
   新鲜度，实机用唯一源序号和时间戳验证真实采样率。
